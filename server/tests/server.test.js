...
// Note:
//      .expect calls are from supertest 
//      whereas
//      expect(..) are from the expect jest package
...
// User collection TCs.
// one with valid auth and one with invalid.
...
describe('POST /users', () => {
    it('Should create a user', (done) => {
        ...
        .expect(200)
        .expect((res) => {
            expect(res.header['x-auth']).toBeTruthy();// need to look into this later.
    ...
    it('Should return validation errors if invalid req', (done) => {
        request(app)
        .post('/users')
        .send({
            email: 'and@',
...
describe('DELETE /users/me/token', ()=> {
    it('should remove authorization token on logout', (done) => {
        request(app)
